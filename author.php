                ...
                <div class="post-container">
                  ...
                  <?php  
                      ...
                      if(isset($_GET['aid'])) {
                       ...
                       $sql1 = "SELECT * FROM post JOIN user ON post.author = user.user_id WHERE post.author = {$author_id}";
                       ...
                       $row1 = mysqli_fetch_assoc($result1);
                         ...
                         $offset = ($page - 1) * $limit;
                         $sql = "SELECT post.post_id, post.title, post.category, post.post_date, post.author, post.post_img, 
                         post.category, post.description,
                         user.user_id, user.username, category.category_id, 
                         category.category_name, category.post
                         FROM post LEFT JOIN user ON post.author = user.user_id 
                         LEFT JOIN category ON post.category = category.category_id WHERE post.author = {$author_id}
